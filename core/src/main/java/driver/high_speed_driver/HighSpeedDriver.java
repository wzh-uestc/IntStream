...
public class HighSpeedDriver implements AbstractDriver {
    private String sip;
    ...
    private List<HighSpeedRule> rules;
    ...
    public HighSpeedDriver(){}

    public HighSpeedDriver(String sip, String sipMask, String dip, String dipMask, String action){
        this.sip = sip;
        ...
        runCommand("addacl " + sip + " " + sipMask + " " +
                dip + " " + dipMask + " " + action);
    }

    public HighSpeedDriver(String sip, String sipMask, String dip, String dipMask, String sport,
        ...
        runCommand("addacl " + sip + " " + sipMask + " " +
                dip + " " + dipMask + " " + sport + " " +
                sportMask + " " + dport + " " + dportMask + " " +
                protocol + " " + protocolMask + " " + action);
    }

    public HighSpeedDriver(List<HighSpeedRule> rules){
        this.rules = rules;

        for(HighSpeedRule rule: rules){
            runCommand(rule.getCommand());
        }
    }
