        ...
        NetStream<String> stream2 = stream
                ...
                .transform((elements, out) -> {
                    ...
                    for (PacketInfo p : elements) {
                        ...
                        else if (p.get("TCP.flags").equals("F")){
                            finCnt++;
                        }
                    }

                    if (synCnt - finCnt > 100) {
                        out.collect(dip);
                    }
                });
